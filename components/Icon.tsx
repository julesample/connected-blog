...
const ICONS: Record<IconName, React.ReactNode> = {
  ...
  'cog-6-tooth': <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.003 1.11-1.226l.043-.018a2.25 2.25 0 012.492 0l.043.018c.549.223 1.02.684 1.11 1.226l.044.269a2.25 2.25 0 01-1.616 2.63l-.043.018a2.25 2.25 0 00-2.492 0l-.043-.018a2.25 2.25 0 01-1.616-2.63l.044-.269zM12 15.75a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5z" />
};
