...
type IconName = 'plus' | 'edit' | 'trash' | 'eye' | 'sparkles' | 'sun' | 'moon' | 'back' | 'save' | 'search' | 'logout' | 'users' | 'info' | 'arrow-up' | 'arrow-down' | 'chat-bubble-left-ellipsis' | 'cog-6-tooth' | 'bars-3' | 'x-mark';
